...
```markdown
# References
- Security practices: https://vibe-coder-docs.mintlify.app/concepts/security/overview
- Database guidance: https://vibe-coder-docs.mintlify.app/concepts/databases-storage
```
...
<AccordionGroup>
  <Accordion title="Claude Code">
    ```bash
    claude mcp add --transport http vibe-coder-docs https://vibe-coder-docs.mintlify.app/mcp
    ```
  ...
  <Accordion title="Cursor">
    ...
    ```json
    {
      "mcpServers": {
        "vibe-coder-docs": {
          "url": "https://vibe-coder-docs.mintlify.app/mcp"
        }
      }
    }
    ```
...
| File | URL | Use Case |
|---|---|---|
| `llms.txt` | [/llms.txt](https://vibe-coder-docs.mintlify.app/llms.txt) | Navigation index — lets AI tools discover what topics are available |
| `llms-full.txt` | [/llms-full.txt](https://vibe-coder-docs.mintlify.app/llms-full.txt) | Full content — all documentation in a single file for pasting into AI chats |
